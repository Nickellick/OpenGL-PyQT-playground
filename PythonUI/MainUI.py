...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.rotation_slider.setMinimum(10)
        self.rotation_slider.setMaximum(90)
        self.rotation_slider.setSingleStep(10)
        self.rotation_slider.setProperty("value", 50)
        ...
        self.lighting_checkbox = QtWidgets.QCheckBox(self.centralwidget)
        self.lighting_checkbox.setGeometry(QtCore.QRect(530, 530, 171, 23))
        self.lighting_checkbox.setObjectName("lighting_checkbox")
        self.csg_button = QtWidgets.QPushButton(self.centralwidget)
        self.csg_button.setGeometry(QtCore.QRect(700, 530, 89, 25))
        self.csg_button.setObjectName("csg_button")
        self.a_and_b_radio = QtWidgets.QRadioButton(self.centralwidget)
        self.a_and_b_radio.setGeometry(QtCore.QRect(540, 410, 112, 23))
        self.a_and_b_radio.setObjectName("a_and_b_radio")
        self.a_or_b_radio = QtWidgets.QRadioButton(self.centralwidget)
        self.a_or_b_radio.setGeometry(QtCore.QRect(540, 380, 112, 23))
        self.a_or_b_radio.setChecked(True)
        self.a_or_b_radio.setObjectName("a_or_b_radio")
        self.b_not_a_radio = QtWidgets.QRadioButton(self.centralwidget)
        self.b_not_a_radio.setGeometry(QtCore.QRect(540, 470, 112, 23))
        self.b_not_a_radio.setObjectName("b_not_a_radio")
        self.a_not_b_radio = QtWidgets.QRadioButton(self.centralwidget)
        self.a_not_b_radio.setGeometry(QtCore.QRect(540, 440, 112, 23))
        self.a_not_b_radio.setObjectName("a_not_b_radio")
        self.csg_control_label = QtWidgets.QLabel(self.centralwidget)
        self.csg_control_label.setGeometry(QtCore.QRect(540, 350, 171, 21))
        self.csg_control_label.setObjectName("csg_control_label")
    ...
    def retranslateUi(self, main_window):
        ...
        self.lighting_checkbox.setText(_translate("main_window", "Enable Lighting"))
        self.csg_button.setText(_translate("main_window", "CSG"))
        self.a_and_b_radio.setText(_translate("main_window", "A and B"))
        self.a_or_b_radio.setText(_translate("main_window", "A or B"))
        self.b_not_a_radio.setText(_translate("main_window", "B not A"))
        self.a_not_b_radio.setText(_translate("main_window", "A not B"))
        self.csg_control_label.setText(_translate("main_window", "CSG Controls"))
